...
/// Email login screen with Liquid Glass UI and subtle globe background
@available(iOS 17.0, *)
        ...
        VStack(spacing: 12) {
            ...
            ZStack {
                ...
                Image(systemName: "envelope.fill")
                    ...
                    .foregroundStyle(
                        LinearGradient(
                            colors: [Color.acAmber300, Color.acAmber500],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        )
                    )
            }
            .shadow(color: Color.acAmber500.opacity(0.3), radius: 20)
