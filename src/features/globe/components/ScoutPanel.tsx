...
const ScoutPanelComponent: React.FC<ScoutPanelProps> = ({
  ...
  const isPaidUser = !!subscriptionStatus && subscriptionStatus.planType !== 'free';
      ...
      >
        ...
        <div className="relative px-6 pt-6 sm:pt-8 pb-5 border-b border-white/5">
          ...
          <p className="text-xs sm:text-sm text-center text-zinc-400">
            Unlock all categories and scout more ZIPs each month
          </p>
        </div>
        ...
        <div className="px-4 sm:px-6 py-5 grid grid-cols-2 gap-3">
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-amber-500/30 flex flex-col relative">
            <h3 className="text-base font-medium text-zinc-300 mb-1">Explorer</h3>
            <div className="flex items-baseline gap-1 mb-1">
              <span className="text-2xl font-bold text-white">$49</span>
              <span className="text-xs text-zinc-500">/mo</span>
            </div>
            <p className="text-[10px] text-zinc-500 mb-2">
              Best for getting started with scouting.
            </p>
            <ul className="space-y-1.5 text-xs text-zinc-400 mb-4 flex-1">
              ...
              <li className="flex items-center gap-1.5">
                <Check className="h-3 w-3 text-zinc-500" />
                Harmony Score + remedies
              </li>
            </ul>
            <button
              onClick={() => handleSubscribe('explorer')}
              disabled={loadingPlan === 'explorer'}
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-white/20 flex flex-col relative">
            ...
            <h3 className="text-base font-medium text-white mb-1">Pioneer</h3>
