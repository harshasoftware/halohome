...
export function Iphone({
    ...
    // Generate unique IDs for this instance to prevent collisions when multiple iPhones are rendered
    const uniqueId = useId()
    const idSuffix = uniqueId.replace(/:/g, "")
    const maskId = `screenPunch-${idSuffix}`
    const clipId = `roundedCorners-${idSuffix}`
